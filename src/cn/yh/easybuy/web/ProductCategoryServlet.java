...
public class ProductCategoryServlet extends HttpServlet {
	...
	public void save(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (i > 0) {
			...
			out.print("<script>alert('添加失败！');location.href='/easybuy/manage/productClass-add.jsp'</script>");
		}
	}
	...
	request.setCharacterEncoding("utf-8");
		...
		if (i > 0) {
			...
			out.print("<script>alert('删除失败！');location.href='/easybuy/manage/productClass-modify.jsp'</script>");
		}
	}
	...
	public void updt(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if (i > 0) {
			...
			out.print("<script>alert('修改失败！');location.href='/easybuy/manage/productClass-modify.jsp'</script>");
		}
	}
